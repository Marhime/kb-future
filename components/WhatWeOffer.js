      ...
      {width > 1023 ? (
        <>
          ...
          <div className="grid lg:grid-cols-2 col-span-2">
            {active === 0 ? (
              <div className="px-2 lg:px-5 w-full flex mb-5 | md:mb-0  ">
                <a
                  onMouseEnter={() => setActive(0)}
                  href="#"
                ...
                >
                  ...
                  <h2
                    className="font-sans-primary text-xl | md:text-2xl 2xl:text-2xl text-primary font-normal leading-tight tracking-tight mb-3 loco--lines-fade-y words lines splitting is-inview"
                  ...
                  <div
                    className="line-clamp-2 delay-200 text-ellipsis | loco--fade-y is-inview"
                    data-scroll=""
                  >
                    <div
                      className="w-full -mb-3 md:-mb-6 | loco--lines-fade-y is-inview"
                      data-scroll=""
                    >
                      <p className="w-full leading-relaxed tracking-tight text-base mb-6 | 3xl:text-md text-primary">
        ...
        <div className="space-y-10">
          ...
          <div className="flex flex-col">
            ...
            />
            <a href="#" className="block w-full group">
              <div className="w-full mb-3 mt-5 mt-3">
                <div
                  className={`text-primary border-primary transition py-0.5 px-2 | lg:px-4 lg:text-md inline-flex rounded-full border borde-solid leading-tight tracking-tight loco--fade-y is-inview`}
                  data-scroll=""
                >
